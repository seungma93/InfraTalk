package com.sm.infratalk.presenter.mypage.adapter
...
import com.sm.infratalk.databinding.ListItemMyBookmarkBoardBinding
...
class MyBookmarkBoardListAdapter(
...
) : ListAdapter<BoardEntity, MyBookmarkBoardListAdapter.ViewHolder>(diffUtil) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ListItemMyBookmarkBoardBinding.inflate(
    ...
    class ViewHolder(
        private val binding: ListItemMyBookmarkBoardBinding,
        private val itemClick: (BoardMetaEntity) -> Unit,
        private val bookmarkClick: (BoardEntity) -> Unit,
        private val likeClick: (BoardEntity) -> Unit,
        private val deleteClick: (BoardEntity) -> Unit,
