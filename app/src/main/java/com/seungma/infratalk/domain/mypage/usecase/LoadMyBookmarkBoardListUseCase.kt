...
class LoadMyBookmarkBoardListUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): BoardListEntity = coroutineScope {
        val boardMetaListEntity = boardDataRepository.loadMyBookmarkBoardList()
