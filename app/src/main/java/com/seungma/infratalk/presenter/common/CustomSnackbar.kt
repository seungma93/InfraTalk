package com.seungma.infratalk.presenter.common
...
import com.seungma.infratalk.databinding.SnackbarCustomBinding
...
class CustomSnackbar private constructor(private val view: View, message: String, duration: Int) {
    ...
    fun setIcon(resourceId: Int) {
        ...
        binding.ivSnackbar.setImageDrawable(drawable)
    }
