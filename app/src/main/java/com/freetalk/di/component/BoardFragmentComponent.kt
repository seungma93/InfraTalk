...
@Component(
    modules = [
        ...
        Modules.InsertBookMarkBoardUseCaseModule::class,
        Modules.DeleteBookMarkBoardUseCaseModule::class,
        Modules.InsertLikeBoardUseCaseModule::class,
        Modules.DeleteLikeBoardUseCaseModule::class,
        Modules.InsertBookMarkBoardContentUseCaseModule::class,
        Modules.DeleteBookMarkBoardContentUseCaseModule::class,
        Modules.SelectBoardContentUseCaseModule::class,
        Modules.BoardContentViewModelModule::class,
        Modules.InsertLikeBoardContentUseCaseModule::class,
        Modules.InsertLikeBoardUseCaseModule::class,
        Modules.DeleteLikeBoardContentUseCaseModule::class,
